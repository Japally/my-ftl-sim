...
dm_time_t 
seek_const(struct dm_disk_if *d,
...
dm_time_t 
seek_3pt_curve(struct dm_disk_if *d,
	       struct dm_mech_state *begin,
	       struct dm_mech_state *end,
	       int rw)
...
dm_time_t 
seek_3pt_line(struct dm_disk_if *d,
	      struct dm_mech_state *begin,
	      struct dm_mech_state *end,
	      int rw)
{
...
dm_time_t 
seek_1st10_plus_hpl(struct dm_disk_if *d, 
		    struct dm_mech_state *begin,
		    struct dm_mech_state *end,
		    int rw)
...
dm_time_t 
seek_extracted(struct dm_disk_if *d,
	       struct dm_mech_state *begin,
	       struct dm_mech_state *end,
	       int rw)
...
/*  	     (m->xseekdists[i] - m->xseekdists[(i-1)]); */
     ...
     ddbg_assert3(result != 0, ("*** error: diskmodel::mech_g1::seek_extracted "
