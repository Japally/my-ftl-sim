...
static struct lp_mod dm_layout_g1_zone_mod = { "dm_layout_g1_zone", dm_layout_g1_zone_params, DM_LAYOUT_G1_ZONE_MAX, (lp_modloader_t)dm_layout_g1_zone_loadparams,  0,0 };
